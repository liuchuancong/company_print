...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  void initState() {
    showGridView.addListener(() {
      ...
      //  Get.offUntil(context, (Route<dynamic> route) => route.settings.name == '/home')
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: AdaptiveLayout(
        ...
        body: SlotLayout(
          config: <Breakpoint, SlotLayoutConfig?>{
            Breakpoints.standard: SlotLayout.from(
              ...
              //  ExamplePage.
              builder: (_) => (navigationIndex.value == 0)
                  ? Padding(
        ...
        secondaryBody: navigationIndex.value == 0
            ? SlotLayout(
                config: <Breakpoint, SlotLayoutConfig?>{
                  Breakpoints.mediumAndUp: SlotLayout.from(
                    ...
                    builder: (_) => SafeArea(
                      child: Obx(() => _DetailTile(item: _allItems[selected.value])),
                    ),
                  )
                },
              )
      ...
      onTap: () {
        ...
        if (!Breakpoints.mediumAndUp.isActive(context)) {
          Navigator.of(context)
              .pushNamed(RoutePath.kDetailView, arguments: _ScreenArguments(item: item, selectCard: selectCard));
        } else {
          selectCard(_allItems.indexOf(item));
        }
      },
