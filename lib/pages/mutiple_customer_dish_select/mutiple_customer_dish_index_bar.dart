...
class MutipleCustomerDishListIndexBar extends StatefulWidget {
  ...
  const MutipleCustomerDishListIndexBar({
    super.key,
  ...
  @override
  State<MutipleCustomerDishListIndexBar> createState() => _MutipleCustomerDishListIndexBarState();
}

class _MutipleCustomerDishListIndexBarState extends State<MutipleCustomerDishListIndexBar> {
